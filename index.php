...
<!-- Mirrored from wpthemesgrid.com/themes/medikit/index2.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 19 Jan 2025 05:43:45 GMT -->
<head>
        <!-- Meta Tags -->
		<meta charset="utf-8">
...
include "navbar.php";
		...
		<!-- Slider Area -->
		<section class="slider index2" id='home'>
				...
				<div class="single-slider" style="background-image:url('img/slider2.jpg')">
					<div class="container">
						<div class="row">
							<div class="col-lg-7">
								<div class="text">
									<h1>Precision You Can Trust –<span> Your Health</span>, Our <sapn>Priority </span></h1>
									<p>At our pathology lab, we prioritize your health by providing precise and reliable test results. Our commitment to accuracy ensures that you receive the best possible care and attention.</p>
									<div class="button">
				...
				<div class="single-slider" style="background-image:url('img/slider.jpg')">
					<div class="container">
						<div class="row">
							<div class="col-lg-7">
								<div class="text">
									<h1>Where Expertise Meets <span>Excellence</span> – Unveiling the Secrets of<sapn> Health.</span></h1>
									<p>Our pathology lab combines scientific expertise with a dedication to excellence. We unravel complex health conditions through detailed analysis, ensuring clarity and confidence in every diagnosis.</p>
									<div class="button">
										<a href="#" class="btn">Contact</a>
				...
				<div class="single-slider" style="background-image:url('img/slider3.jpg')">
					<div class="container">
						<div class="row">
							<div class="col-lg-7">
								<div class="text">
									<h1><span>Accurate</span> Results, Faster Diagnosis – Leading the Way in <span>Pathology.</span></h1>
									<p>Experience the gold standard in pathology services with our cutting-edge technology and expert team. We deliver accurate results swiftly, aiding in faster and more effective diagnoses.</p>
									<div class="button">
										<a href="#" class="btn">Contact</a>
...
$stmt = $dbpdo->prepare("SELECT COUNT(*) AS company
FROM `company` 
");
$stmt->execute();
$company = $stmt->fetch(PDO::FETCH_ASSOC);
                            ...
                            ?>
							<div class="content">
								<span class="counter"><?php echo $company['company']; ?></span>
								<p>Total Labs</p>
							</div>
						</div>
						<!-- End Single Fun -->
...
$stmt = $dbpdo->prepare("SELECT COUNT(*) AS patients
FROM `patients` 
WHERE p_status = 1
");
$stmt->execute();
$user = $stmt->fetch(PDO::FETCH_ASSOC);
                            ...
                            ?>
								<span class="counter"><?php echo $user['patients']; ?></span>
								<p>Happy Patients</p>
							</div>
						</div>
						<!-- End Single Fun -->
...
$stmt = $dbpdo->prepare("SELECT COUNT(*) AS patient_test
FROM `patient_test` 
");
$stmt->execute();
$tests = $stmt->fetch(PDO::FETCH_ASSOC);
							...
							<div class="content">
								<span class="counter"><?php echo $tests['patient_test']  ?></span>
								<p>Total Reports Genrated</p>
							</div>
						</div>
						<!-- End Single Fun -->
					</div>
